  ...
  functions: [
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/search",
        method: "GET",
        headers: {
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/get-product-details",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/track-order",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/cancel-order",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/initiate-return",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/get-order-history",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/add-to-cart",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/get-cart",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/apply-coupon",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/ecommerce/check-availability",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
