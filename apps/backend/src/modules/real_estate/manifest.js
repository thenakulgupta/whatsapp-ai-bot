  ...
  functions: [
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/real-estate/search-properties",
        method: "GET",
        headers: {
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/real-estate/get-property-details",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/real-estate/schedule-visit",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/real-estate/get-scheduled-visits",
        method: "GET",
      },
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/real-estate/cancel-visit",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/real-estate/get-loan-estimate",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/real-estate/get-area-info",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    },
    {
      ...
      apiInfo: {
        url: "https://whatsapp-ai-bot-backend.nakultelestock.com/demo-data/real-estate/compare-properties",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
